...
public class ConnectorRestApiCallOrderByInput implements java.io.Serializable {
    ...
    public ConnectorRestApiCallOrderByInput() {
    }

    public ConnectorRestApiCallOrderByInput(SortOrder id, SortOrder createdAt, SortOrder updatedAt, SortOrder blockType, SortOrder displayName, SortOrder description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public ConnectorRestApiCallOrderByInput build() {
            return new ConnectorRestApiCallOrderByInput(id, createdAt, updatedAt, blockType, displayName, description);
        }
