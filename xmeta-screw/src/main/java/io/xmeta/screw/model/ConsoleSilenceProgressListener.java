 ...
 */
public class ConsoleSilenceProgressListener implements ProgressListener {
    ...
    public ConsoleSilenceProgressListener(boolean render) {
    	this.render = render;
	...
	public long finished(Collection<Table> tables, Config config) {
		...
		if (render) {
	        System.err.flush();
	        System.out.flush();
            System.out.println("Wrote relationship details in " + duration / 1000 + " seconds.");
		}
