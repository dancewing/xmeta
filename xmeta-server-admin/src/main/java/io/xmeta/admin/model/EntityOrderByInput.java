...
public class EntityOrderByInput implements java.io.Serializable {
    ...
    public EntityOrderByInput() {
    }

    public EntityOrderByInput(SortOrder id, SortOrder createdAt, SortOrder updatedAt, SortOrder name, SortOrder displayName, SortOrder pluralDisplayName, SortOrder description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public EntityOrderByInput build() {
            return new EntityOrderByInput(id, createdAt, updatedAt, name, displayName, pluralDisplayName, description);
        }
