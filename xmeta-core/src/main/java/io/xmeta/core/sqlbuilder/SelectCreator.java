...
public class SelectCreator extends AbstractSqlCreator implements Cloneable {
    ...
    public SelectCreator(Entity entity) {
        super(entity);
    }
...
//            throws SQLException {
//                return createSqlParameterSource()
...
//    }
    ...
    public String toString() {
        SqlParameterSource ppsc = createSqlParameterSource();
        StringBuilder sb = new StringBuilder(builder.toString());
        List<String> params = Arrays.asList(ppsc.getParameterNames());
        Collections.sort(params);
        for (String s : params) {
            sb.append(", ").append(s).append("=").append(ppsc.getTypeName(s));
        }
        return sb.toString();
    }
