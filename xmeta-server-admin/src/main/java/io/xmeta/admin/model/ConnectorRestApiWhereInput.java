...
public class ConnectorRestApiWhereInput implements java.io.Serializable {
    ...
    public ConnectorRestApiWhereInput() {
    }

    public ConnectorRestApiWhereInput(StringFilter id, DateTimeFilter createdAt, DateTimeFilter updatedAt, WhereUniqueInput app, WhereUniqueInput parentBlock, StringFilter displayName, StringFilter description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public ConnectorRestApiWhereInput build() {
            return new ConnectorRestApiWhereInput(id, createdAt, updatedAt, app, parentBlock, displayName, description);
        }
