 ...
 */
package io.xmeta.screw.dbms.config;

import io.xmeta.screw.dbms.exceptions.ResourceNotFoundException;
...
public class PropertiesFinder implements ResourceFinder {
    ...
    private static final String DB_TYPES_LOCATION = "io/xmeta/screw/types/";
