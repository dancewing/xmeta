...
public class ConnectorRestApiOrderByInput implements java.io.Serializable {
    ...
    public ConnectorRestApiOrderByInput() {
    }

    public ConnectorRestApiOrderByInput(SortOrder id, SortOrder createdAt, SortOrder updatedAt, SortOrder blockType, SortOrder displayName, SortOrder description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public ConnectorRestApiOrderByInput build() {
            return new ConnectorRestApiOrderByInput(id, createdAt, updatedAt, blockType, displayName, description);
        }
