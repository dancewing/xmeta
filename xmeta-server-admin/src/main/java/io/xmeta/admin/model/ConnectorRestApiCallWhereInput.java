...
public class ConnectorRestApiCallWhereInput implements java.io.Serializable {
    ...
    public ConnectorRestApiCallWhereInput() {
    }

    public ConnectorRestApiCallWhereInput(StringFilter id, DateTimeFilter createdAt, DateTimeFilter updatedAt, WhereUniqueInput app, WhereUniqueInput parentBlock, StringFilter displayName, StringFilter description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public ConnectorRestApiCallWhereInput build() {
            return new ConnectorRestApiCallWhereInput(id, createdAt, updatedAt, app, parentBlock, displayName, description);
        }
