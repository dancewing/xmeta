...
public class EntityPageListSettingsInput implements java.io.Serializable {
    ...
    public EntityPageListSettingsInput() {
    }

    public EntityPageListSettingsInput(boolean allowCreation, boolean allowDeletion, boolean enableSearch, String navigateToPageId) {
    ...
    public static class Builder {
        ...
        public EntityPageListSettingsInput build() {
            return new EntityPageListSettingsInput(allowCreation, allowDeletion, enableSearch, navigateToPageId);
        }
