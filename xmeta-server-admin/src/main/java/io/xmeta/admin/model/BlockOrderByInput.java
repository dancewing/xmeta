...
public class BlockOrderByInput implements java.io.Serializable {
    ...
    public BlockOrderByInput() {
    }

    public BlockOrderByInput(SortOrder id, SortOrder createdAt, SortOrder updatedAt, SortOrder blockType, SortOrder displayName, SortOrder description) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public BlockOrderByInput build() {
            return new BlockOrderByInput(id, createdAt, updatedAt, blockType, displayName, description);
        }
