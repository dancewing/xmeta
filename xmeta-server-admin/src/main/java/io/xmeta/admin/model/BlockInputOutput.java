...
public class BlockInputOutput implements java.io.Serializable {
    ...
    @javax.validation.constraints.NotNull
    private java.util.List<PropertySelector> propertyList;

    public BlockInputOutput() {
    }

    public BlockInputOutput(String name, String description, EnumDataType dataType, String dataTypeEntityName, Boolean isList, Boolean includeAllPropertiesByDefault, java.util.List<PropertySelector> propertyList) {
        this.name = name;
    ...
    public java.util.List<PropertySelector> getPropertyList() {
        return propertyList;
    }
    public void setPropertyList(java.util.List<PropertySelector> propertyList) {
        this.propertyList = propertyList;
    }
    ...
    public static class Builder {
        ...
        public Builder setPropertyList(java.util.List<PropertySelector> propertyList) {
            this.propertyList = propertyList;
            return this;
        }


        public BlockInputOutput build() {
            return new BlockInputOutput(name, description, dataType, dataTypeEntityName, isList, includeAllPropertiesByDefault, propertyList);
        }
